...
{!isImageLoaded && 
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
      ...
      type="text" placeholder='Describe what you want to generate' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20' name="" id="" />
      <button type='submit' className='bg-zinc-900 px-10 sm:px-16 py-4 rounded-full'>Generate</button>
    </div>
    }
